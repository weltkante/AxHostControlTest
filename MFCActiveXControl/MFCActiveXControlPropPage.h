...
// MFCActiveXControlPropPage.h : Declaration of the CMFCActiveXControlPropPage property page class.


// CMFCActiveXControlPropPage : See MFCActiveXControlPropPage.cpp for implementation.
